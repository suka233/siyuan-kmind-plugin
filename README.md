...
# KMind v2.14.0 维护阶段说明

感谢你一直使用 KMind2。

KMind2 目前已经进入维护阶段：我会继续保证它在思源中的稳定可用，如果因为思源更新导致不可用，也会及时修复。

后续的新功能、新平台适配和长期演进，会主要基于全新自研内核的 KMind Zen 开发。KMind Zen 是从 0 重新设计的新一代导图工具，会面向思源、Obsidian、网页端以及未来的桌面客户端等工作流持续迭代。

KMind2 不会立刻停止使用，但 KMind Zen 会是之后主要投入和更新的方向。强烈建议你开始尝试，并逐步迁移到 KMind Zen。

[KMind Zen vs KMind2：新旧版本有什么区别](https://kmind.app/zh/tutorials/kmind-zen-vs-kmind2)
